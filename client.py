...
class GUI:
	...
	def layout(self,name):
		...
		self.labelBottom = Label(self.Window, bg="#17202A", height = 80)
		...
		self.buttonmessage = Button(self.labelBottom, bg="#ffa500", text="Send", font="Helvetica 10 bold", width = 20, command = lambda: self.sendButton(self.entrymessage.get()))
